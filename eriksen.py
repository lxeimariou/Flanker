...
on 2021-01-12 14:16:22. The code is partially based on the PsychoPy Builder compiler code and demos.
...
EriksenFlanker_sound = sound.Sound(value=800)
EriksenFlanker_sound.model_name = None
EriksenFlanker_sound.cname = 'EriksenFlanker_sound'

EriksenFlanker_sound_2 = sound.Sound(value=400)
EriksenFlanker_sound_2.model_name = None
EriksenFlanker_sound_2.cname = 'EriksenFlanker_sound_2'
...
EriksenFlanker_components = [
    ...
    EriksenFlanker_sound,
    EriksenFlanker_sound_2]
...
real = visual.TextStim(win=win, name='real', height=0.08, text='')
      ...
      {'vars': {'repeats': 1,
        ...
        'ph_exec': [
            ...
            {'inst': EriksenFlanker_keyboard,
                ...
                'params': {'correct': 'left'}}],
        'ph_error': [
            {'inst': EriksenFlanker_sound,
                'type': 'audible.sound',
                'at': 0.0,
                'duration': 0.3,
                'params': {}}],
        'ph_correct': [
            {'inst': EriksenFlanker_sound_2,
                'type': 'audible.sound',
                'at': 0.0,
                'duration': 0.3,
                'params': {}}]},
